...
export async function POST() {
  try {
    ...
    const productsData = [
      ...
      { name: 'Custom Hand-Painted Tee', slug: 'custom-hand-painted-tee', price: 15000, categoryId: tshirts.id, brand: 'Custom', condition: 'CUSTOM', featured: true, images: '["https://picsum.photos/seed/custom-tee-1/600/800", "https://picsum.photos/seed/custom-tee-2/600/800"]', colors: '["White","Black"]', sizes: '["S","M","L","XL"]' },
      ...
      { name: 'Custom Embroidered Jacket', slug: 'custom-embroidered-jacket', price: 35000, categoryId: jackets.id, brand: 'Custom', condition: 'CUSTOM', images: '["https://picsum.photos/seed/embroidered-jacket-1/600/800", "https://picsum.photos/seed/embroidered-jacket-2/600/800"]', colors: '["Black","Navy"]', sizes: '["S","M","L","XL"]' },
      ...
      { name: 'Nike Air Force 1 Custom', slug: 'nike-air-force-1-custom', price: 25000, categoryId: sneakers.id, brand: 'Custom', condition: 'CUSTOM', featured: true, images: '["https://picsum.photos/seed/af1-custom-1/600/800", "https://picsum.photos/seed/af1-custom-2/600/800"]', colors: '["White Custom","Black Custom"]', sizes: '["EU 39","EU 40","EU 41","EU 42","EU 43","EU 44"]' },
      ...
      { name: 'Custom Name Chain', slug: 'custom-name-chain', price: 12000, categoryId: chains.id, brand: 'Custom', condition: 'CUSTOM', isNew: true, images: '["https://picsum.photos/seed/custom-chain-1/600/800", "https://picsum.photos/seed/custom-chain-2/600/800"]', colors: '["Gold","Silver"]', sizes: '["16\\"","18\\"","20\\"","22\\""]' },
